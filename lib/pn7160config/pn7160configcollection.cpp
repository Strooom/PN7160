...
const uint8_t setTotalDurationConfigData[2]{0xF4, 0x01};                                                              // TOTAL_DURATION = 500ms
const uint8_t powerManagementConfigData[11]{0x11, 0x01, 0xC1, 0xB1, 0x00, 0xDA, 0x1E, 0x14, 0x00, 0xD0, 0x0C};        // PMU_CFG selects CFG1
